    ...
    public static class ModelBuilderExtensions
    {
        public static void seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NhanVienPhongBan>().HasData(
                new NhanVienPhongBan() { MaNhanVien = "IT002", TenNhanVien = "Mai Thuy Nga", MaCapBac = "c3", MaPhongBan = "IT" },
                new NhanVienPhongBan() { MaNhanVien = "IT003", TenNhanVien = "Vu Duc Thi", MaCapBac = "c1", MaPhongBan = "IT" },
                new NhanVienPhongBan() { MaNhanVien = "IT001", TenNhanVien = "Cao Kim Anh", MaCapBac = "c2", MaPhongBan = "IT" },
                new NhanVienPhongBan() { MaNhanVien = "IT004", TenNhanVien = "Pham Phuong Thanh", MaCapBac = "c4", MaPhongBan = "IT" },
                new NhanVienPhongBan() { MaNhanVien = "IT006", TenNhanVien = "Nguyen Duc Dan", MaCapBac = "c5", MaPhongBan = "IT" },
                new NhanVienPhongBan() { MaNhanVien = "IT005", TenNhanVien = "Tran Thi Hue", MaCapBac = "c6", MaPhongBan = "IT" },
                new NhanVienPhongBan() { MaNhanVien = "KT002", TenNhanVien = "Nham Ngoc Tan", MaCapBac = "c3", MaPhongBan = "KT" },
                new NhanVienPhongBan() { MaNhanVien = "KT001", TenNhanVien = "Ha Huy Khoai", MaCapBac = "c1", MaPhongBan = "KT" },
                new NhanVienPhongBan() { MaNhanVien = "KT003", TenNhanVien = "Nguyen Hong Nhung", MaCapBac = "c4", MaPhongBan = "KT" },
                new NhanVienPhongBan() { MaNhanVien = "KT004", TenNhanVien = "Hoang Ngoc Tung", MaCapBac = "c2", MaPhongBan = "KT" },
                new NhanVienPhongBan() { MaNhanVien = "KT006", TenNhanVien = "Nguyen Lam Tung", MaCapBac = "c5", MaPhongBan = "KT" },
                new NhanVienPhongBan() { MaNhanVien = "KT005", TenNhanVien = "Nguyen Quoc Tuan", MaCapBac = "c6", MaPhongBan = "KT" },
                new NhanVienPhongBan() { MaNhanVien = "DT001", TenNhanVien = "Nguyen Thi Hoa", MaCapBac = "c1", MaPhongBan = "DT" },
                new NhanVienPhongBan() { MaNhanVien = "DT002", TenNhanVien = "Tran Quoc Hung", MaCapBac = "c2", MaPhongBan = "DT" },
                new NhanVienPhongBan() { MaNhanVien = "DT003", TenNhanVien = "Nguyen Canh Toan", MaCapBac = "c3", MaPhongBan = "DT" },
                new NhanVienPhongBan() { MaNhanVien = "DT006", TenNhanVien = "Mai Tien Dung", MaCapBac = "c4", MaPhongBan = "DT" },
                new NhanVienPhongBan() { MaNhanVien = "DT005", TenNhanVien = "Nguyen Duc Khoa", MaCapBac = "c5", MaPhongBan = "DT" },
                new NhanVienPhongBan() { MaNhanVien = "DT004", TenNhanVien = "Le Huyen Trang", MaCapBac = "c6", MaPhongBan = "DT" },
                new NhanVienPhongBan() { MaNhanVien = "TT001", TenNhanVien = "Nguyen Ngoc Quang", MaCapBac = "c1", MaPhongBan = "TT" },
                new NhanVienPhongBan() { MaNhanVien = "TT003", TenNhanVien = "Tran Huy Hoang", MaCapBac = "c2", MaPhongBan = "TT" },
                new NhanVienPhongBan() { MaNhanVien = "TT004", TenNhanVien = "Vu Tuan Tu", MaCapBac = "c5", MaPhongBan = "TT" },
                new NhanVienPhongBan() { MaNhanVien = "TT006", TenNhanVien = "Nguyen Thi Nga", MaCapBac = "c3", MaPhongBan = "TT" },
                new NhanVienPhongBan() { MaNhanVien = "TT002", TenNhanVien = "Tran Thuy Duong", MaCapBac = "c4", MaPhongBan = "TT" },
                new NhanVienPhongBan() { MaNhanVien = "TT005", TenNhanVien = "Nguyen Van Thieu", MaCapBac = "c6", MaPhongBan = "TT" },
                new NhanVienPhongBan() { MaNhanVien = "NN001", TenNhanVien = "Pham Hai Yen", MaCapBac = "c2", MaPhongBan = "NN" },
                new NhanVienPhongBan() { MaNhanVien = "NN006", TenNhanVien = "Bui Sy Thang", MaCapBac = "c3", MaPhongBan = "NN" },
                new NhanVienPhongBan() { MaNhanVien = "NN002", TenNhanVien = "Tran Hoang Duong", MaCapBac = "c6", MaPhongBan = "NN" },
                new NhanVienPhongBan() { MaNhanVien = "NN004", TenNhanVien = "Mai Xuan The", MaCapBac = "c1", MaPhongBan = "NN" },
                new NhanVienPhongBan() { MaNhanVien = "NN003", TenNhanVien = "Mai Lan", MaCapBac = "c4", MaPhongBan = "NN" },
                new NhanVienPhongBan() { MaNhanVien = "NN005", TenNhanVien = "Nguyen Bich Tram", MaCapBac = "c5", MaPhongBan = "NN" },
                new NhanVienPhongBan() { MaNhanVien = "CT001", TenNhanVien = "Le Thi Quy", MaCapBac = "c2", MaPhongBan = "CT" },
                new NhanVienPhongBan() { MaNhanVien = "CT003", TenNhanVien = "Ho Xuan Ngoc", MaCapBac = "c1", MaPhongBan = "CT" },
                new NhanVienPhongBan() { MaNhanVien = "CT005", TenNhanVien = "Hoang Ngoc Ha", MaCapBac = "c5", MaPhongBan = "CT" },
                new NhanVienPhongBan() { MaNhanVien = "CT002", TenNhanVien = "Nguyen Van Lich", MaCapBac = "c6", MaPhongBan = "CT" },
                new NhanVienPhongBan() { MaNhanVien = "CT004", TenNhanVien = "Nguyen Thi Hai", MaCapBac = "c3", MaPhongBan = "CT" },
                new NhanVienPhongBan() { MaNhanVien = "CT006", TenNhanVien = "Dang canh Khanh", MaCapBac = "c4", MaPhongBan = "CT" }
                );
