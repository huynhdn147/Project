    ...
    public static class ModelBuilderExtensions
    {
        public static void seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserRole>().HasData(
                ...
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK001" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK002" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK003" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK004" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK005" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK006" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK007" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK008" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK009" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK011" },
                //new UserRole() { RoleId = "RL02", MaNhanVien = "TK012" },
                //
